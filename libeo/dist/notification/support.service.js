...
const zendesk_ticket_interface_1 = require("./interface/zendesk-ticket.interface");
const common_1 = require("@nestjs/common");
let SupportService = class SupportService {
    constructor(zendeskService) {
        this.zendeskService = zendeskService;
    }
    createTicketNewUser(user) {
...
SupportService = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [zendesk_service_1.ZendeskService])
], SupportService);
