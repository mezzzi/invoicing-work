...
let HistoriesService = class HistoriesService {
    ...
    findByInvoiceId(id, orderBy, limit, offset) {
        return __awaiter(this, void 0, void 0, function* () {
            const [history, total] = yield this.historyRepository.findAndCount({
                where: {
...
HistoriesService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(history_entity_1.History)),
