...
let EmailsService = class EmailsService {
    ...
    createEmails(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const emails = this.emailRepository.create(data);
    ...
    findByContact(contact, orderBy, limit, offset) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield Promise.all([
                yield this.emailRepository.count({ contact }),
                yield this.emailRepository.find({ where: { contact }, skip: offset, take: limit }),
            ]);
            return {
                total: result[0],
                rows: result[1],
