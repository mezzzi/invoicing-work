...
export declare enum UserParentType {
    SHAREHOLDER = "shareholder",
    EMPLOYEE = "employee",
    LEADER = "leader"
}
export declare enum UserSpecifiedUSPerson {
    No = 0,
    YES = 1
}
export declare enum UserControllingPersonType {
    Shareholder = 1,
    OTHER_RELATIONSHIP = 2,
    DIRECTOR = 3,
    NONE = 4
}
export declare enum UserEmployeeType {
    LEADER = 1,
    EMPLOYEE = 2,
    NONE = 3
}
